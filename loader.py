...
if __name__ == '__main__':
    ...
    for v in dev_instances.itervalues():
        print "sysnset: " + wn.synsets(v.lemma)[0]
        print "lesk: " + lesk(v.context, v.lemma, v.index)


    for v in test_instances.itervalues():
        print wn.synsets(v.lemma)[0]
